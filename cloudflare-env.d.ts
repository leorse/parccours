/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 67f56694c252b2d548ff4b5e651832d1)
// Runtime types generated with workerd@1.20260722.1 2024-09-23 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	ONE_MIN_AI_API_KEY: string;
	WORKER_SELF_REFERENCE: Fetcher /* parccours-dev */ | Service<typeof import("./.open-next/worker").default>;
}
declare namespace Cloudflare {
	...
	interface DevEnv {
		...
		AUTH_GOOGLE_SECRET: string;
		ONE_MIN_AI_API_KEY: string;
		WORKER_SELF_REFERENCE: Fetcher /* parccours-dev */;
	}
